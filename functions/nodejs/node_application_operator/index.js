 ...
 */
 module.exports = async function (params, context, logger) {
  ...
  .where({
    "multi_option": application.operator.hasAnyOf("option_6f48aab69aa","option_f48aab69aad")
  })
  .find()
  ...
  .select('_id','name','age','multi_option')
  .where({
    "multi_option": application.operator.hasNoneOf("option_6f48aab69aa","option_f48aab69aad")
  })
  .find()
